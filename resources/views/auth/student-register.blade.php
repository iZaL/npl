    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-8">
                ...
                <div class="blockpara">
                    <form class="form-horizontal" role="form" method="POST" action="{{ action('Auth\AuthController@postStudentRegistration') }}">
                    ...
                    <textarea name="address_en" id="address_en" placeholder=" Address" class="form-control"
                        ...
                        <select class="form-control" placeholder="Level" name="levels[]" id="levels">
